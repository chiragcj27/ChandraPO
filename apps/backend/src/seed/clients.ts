...
const defaultClients: SeedClient[] = [
  {
    ...
    mapping: [
      ...
      'OrderQty -> Pieces',
      'OrderItemPcs -> Pieces',
      'Metal -> Use description last 2-3 words; convert to Enum value from ["G09KT", "G10KT", "G14KT", "G18KT", "PT950", "S925"]. Map variations (e.g., "9KT" -> "G09KT", "14K" -> "G14KT", "18K" -> "G18KT", "Platinum" or "PT950" or "950" -> "PT950", "Silver" or "925" or "SV925" -> "S925")',
      ...
      'StockType -> Extract from Description or Category field; look for keywords like "Studded", "Plain", "Gold", "Platinum", "Silver", "Semi Mount", "Mount", "Combination", "Normal" and match to enum: ["Normal", "Studded Gold Jewellery IC", "Studded Platinum Jewellery IC", "Plain Gold Jewellery IC", "Plain Platinum Jewellery IC", "Studded Semi Mount Gold Jewellery IC", "Studded Silver Jewellery IC", "Plain Silver Jewellery IC", "Studded Semi Mount Platinum Jewellery IC", "Gold Mount Jewellery IC", "Studded Combination Jewellery IC"]. Use null if not present or no match.',
  ...
  },
  {
    ...
    mapping: [
      ...
      'Metal -> Metal Type convert to Enum value from ["G09KT", "G10KT", "G14KT", "G18KT", "PT950", "S925"]. Map variations (e.g., "9KT" -> "G09KT", "14K" -> "G14KT", "18K" -> "G18KT", "Platinum" or "PT950" or "950" -> "PT950", "Silver" or "925" or "SV925" -> "S925")',
  ...
  },
  {
    ...
    mapping: [
      ...
      'Metal -> Description first few words; convert to Enum value from ["G09KT", "G10KT", "G14KT", "G18KT", "PT950", "S925"]. Map variations (e.g., "9KT" -> "G09KT", "14K" -> "G14KT", "18K" -> "G18KT", "Platinum" or "PT950" or "950" -> "PT950", "Silver" or "925" or "SV925" -> "S925")',
