...
- Metal: MUST extract from Description field (or Category if available). Must be one of: "G09KT", "G10KT", "G14KT", "G18KT", "950", "SV925". Look for metal information in descriptions (e.g., "9KT", "10KT", "14K", "18K", "Platinum", "PT950", "Silver", "925"). Map variations: "9KT" -> "G09KT", "10KT" -> "G10KT", "14K" -> "G14KT", "18K" -> "G18KT", "Platinum" or "PT950" -> "950", "Silver" or "925" -> "SV925". If no match is found, use the extracted value as-is.
...
- StockType: MUST extract from Description field (or Category if available). Look for keywords like "Studded", "Plain", "Gold", "Platinum", "Silver", "Semi Mount", "Mount", "Combination" in descriptions. Must be one of: "Studded Gold Jewellery IC", "Studded Platinum Jewellery IC", "Plain Gold Jewellery IC", "Plain Platinum Jewellery IC", "Studded Semi Mount Gold Jewellery IC", "Studded Silver Jewellery IC", "Plain Silver Jewellery IC", "Studded Semi Mount Platinum Jewellery IC", "Gold Mount Jewellery IC", "Studded Combination Jewellery IC". Match extracted values to the closest option based on keywords (e.g., "Studded" + "Gold" -> "Studded Gold Jewellery IC", "Plain" + "Platinum" -> "Plain Platinum Jewellery IC"). If no match is found, use null.
