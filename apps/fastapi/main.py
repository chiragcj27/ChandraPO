...
- Category: MUST extract from Description field or dedicated Category column if present. Look for jewelry type keywords. Must be one of: "Ring", "Band", "Pendant", "Necklace", "Bracelet", "Earings", "Bangle". Match extracted values case-insensitively to these exact options (e.g., "ring" -> "Ring", "EARRING" or "EARRINGS" -> "Earings", "bangle" -> "Bangle"). If no match is found, use the extracted value as-is or "" if not present.
