      ...
      try {
        ...
        try {
          ...
          if (res.ok) {
            ...
            setItems([...data.AutoGeneratedContent].map(item => ({ ...item, InvoiceNumber: "" })));
            ...
            if (data.PO && data.PO.length > 0) {
              ...
              setPdfUrl(getApiEndpoint(`/po/${decodedPoNumber}/pdf?file=${encodeURIComponent(filePath)}`));
              ...
              if (ext === 'xlsx' || ext === 'xls') {
                setFileType('excel');
                // Load Excel file
                loadExcelFile(getApiEndpoint(`/po/${decodedPoNumber}/pdf?file=${encodeURIComponent(filePath)}`));
              } else {
                setFileType('pdf');
              }
            }
        ...
        if (mockPO) {
          ...
          setItems([...mockPO.AutoGeneratedContent].map(item => ({ ...item, InvoiceNumber: "" })));
          setUsingMock(true);
